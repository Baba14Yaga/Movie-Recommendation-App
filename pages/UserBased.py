...
def app(user_id):
    ...
    def recommend(selected_movie):
        ...
        movies_list=movies['recommendations'].iloc[movie_index] #returning the index of recommended movie
        movies_name=[]
        movies_posters=[]
        genre_list=[]
        overview_list=[]
    ...
    movies = pickle.load(open('userbased.pkl','rb')) # reads the processed data from content_based.pkl
